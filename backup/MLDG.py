...
def main():
    ...
    # 元训练
    meta_train_mldg(meta_model, meta_optimizer, all_tasks, num_iterations, inner_lr, inner_steps, meta_val_beta,num_meta_val_domains,eval_interval)
